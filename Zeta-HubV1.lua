...
local NotiFrame = Instance.new("Frame")
	...
	DiscordLib:Notification("Thông Báo" , "Loading Script" , 6 ,11816162894 )
	DiscordLib:Notification("Thông Báo" , "Link Shop Ở Phần Setting" , 6 ,11816162894 )
...
Setting:Label("Hãy Mua Bản Premium")

Setting:Line()

Setting:Button("Sao Chép Link Shop",function()
 
 setclipboard("https://ztshop.site")
  DiscordLib:Notification("Thông Báo" , "Đã Sao Chép Link" , 10 ,11816162894 )
 end)
...
TextLabel.Font = Enum.Font.SourceSans
TextLabel.Text = "Zeta-Hub | Script Normal"
TextLabel.TextColor3 = Color3.fromRGB(255, 255, 255)
